    ...
    <Screen style={styles.container}>
      <View style={styles.containerBackground}>
        <View style={tw`flex justify-center items-center`}>
          ...
          />
          <Text style={{ color: '#fff', marginTop: -5, fontSize: 18 }}>Trở thành hội viên của ReadBook</Text>
        </View>
        ...
        <View style={tw`pl-24px`}>
          <View style={tw`flex-row py-4px items-center`}>
            ...
            />
            <Text style={tw`pl-8px text-white`}>Các khuyến mại độc quyền tại Readbook</Text>
          </View>
          <View style={tw`flex-row py-4px items-center`}>
            <Image
              source={require('../../asset/tick-circle.png')}
            ...
            />
            <Text style={tw`pl-8px text-white`}>Đề xuất dành riêng cho bạn.</Text>
          </View>
          <View style={tw`flex-row py-4px items-center`}>
            <Image
              source={require('../../asset/tick-circle.png')}
            ...
            />
            <Text style={tw`pl-8px text-white`}>Mở khóa đầy đủ nội dung sách.</Text>
          </View>
        </View>
      ...
      <View style={tw`pl-24px mt-8px`}>
        ...
        <Text style={tw`text-13px p-8px`}>
          Khi ấn thanh toán đồng nghĩa với việc bạn đồng í với điều khoản sử dụng của ReadBook
        </Text>
      </View>
